...
internal class MimeKitEmailSender(ILogger<MimeKitEmailSender> logger) : IMimeKitEmailSender
{
  public async Task SendEmailAsync(string to, string from, string subject, string body, CancellationToken ct)
  {
